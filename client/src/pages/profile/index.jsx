...
import { AArrowUp, Truck } from 'lucide-react';
...
const Profile = () => {
  ...
  const handleNavigate = () => {
    if (userInfo.profileSetup) {
      ...
      toast.warning('You must set Your profile to continue');
    }
  };
  ...
  return (
    <div className="flex bg-[#1b1c24] h-[100vh] flext items-center justify-center flex-col gap-10 ">
